                                        ...
                                        <tr>
                                            <td valign="top" class="bodyContent" mc:edit="body_content">
                                                <p> Excite Holiday ATM </p>
                                                		<h1>Withdraw Request Success</h1>
		<% int dto = (int) request.getAttribute("message"); %>
		<% int dispenseNote20 = (int) request.getAttribute("dispensenote20"); %>
		<% int requestAmount = (int) request.getAttribute("requestamount"); %>
			50 Note x <%= dto %> </br>
			20 Note x <%= dispenseNote20 %>  </br>
			Requested Amount :  <%= requestAmount %> 
		  <form name="loginForm" method="get" action="atmServiceRequestHandle">
    			press the button to terminate the process  <br/>
