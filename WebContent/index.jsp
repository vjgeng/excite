...
<center>
		...
		<%@ page import="excite.holiday.simulation.atm.dto.AtmDto" %>
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0"  height="680px" width="100%" id="templateBody">
                                        <tr>
                                            <td valign="top" class="bodyContent" mc:edit="body_content">
		    									...
		    									Avaibleable Note : &nbsp;&nbsp;
        							<c:forEach items="${getNoteTypeList}" var="atm">
        	 							${atm.getTwentyType()} &nbsp;&nbsp;
        							</c:forEach>
       				 <form name="loginForm" method="post" action="atmServiceRequestHandle">
    		 			Please enter the withdraw request amount : <input type="text" name="amountRequest"/> <br/>
